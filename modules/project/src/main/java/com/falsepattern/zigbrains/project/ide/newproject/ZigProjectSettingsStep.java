...
public class ZigProjectSettingsStep extends ProjectSettingsStepBase<ZigProjectConfigurationData> {
    public ZigProjectSettingsStep(DirectoryProjectGenerator<ZigProjectConfigurationData> projectGenerator) {
